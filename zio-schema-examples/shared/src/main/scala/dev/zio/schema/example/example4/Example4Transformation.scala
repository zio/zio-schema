...
private[example4] object Domain {
  ...
  object WebPerson {
    val name: Schema.Field[String, WebPerson] = Schema.Field[String, WebPerson]("name", Schema.primitive[String])
    val age: Schema.Field[Int, WebPerson]     = Schema.Field[Int, WebPerson]("age", Schema.primitive[Int])
  ...
  object DomainPerson {
    val firstname: Schema.Field[String, DomainPerson] = Schema.Field("firstname", Schema.primitive[String])
    val lastname: Schema.Field[String, DomainPerson]  = Schema.Field("lastname", Schema.primitive[String])
    val years: Schema.Field[Int, DomainPerson]        = Schema.Field("years", Schema.primitive[Int])
