...
private[codec] object GeoJsonTestData {
  ...
  object GeoJSON {
    ...
    object Geometry {
      case object Point              extends Geometry
      case object MultiPoint         extends Geometry
      case object LineString         extends Geometry
      case object MultiLineString    extends Geometry
      case object Polygon            extends Geometry
      case object MultiPolygon       extends Geometry
      case object GeometryCollection extends Geometry
  ...
  val allCases: List[GeoJSON] = List(
    // level-2 leaves (zero-arg — exercise constructEnumCase)
    Point,
    MultiPoint,
    LineString,
    MultiLineString,
    ...
    Feature(Some(Point), None),
    Feature(Some(LineString), Some((0.0, 0.0, 1.0, 1.0))),
    Feature(Some(Polygon), None),
    Feature(None, None),
    FeatureCollection(List(Feature(Some(MultiPolygon), None)), None),
