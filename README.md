...
```scala
libraryDependencies += "dev.zio" %% "zio-schema"          % "0.4.1"
libraryDependencies += "dev.zio" %% "zio-schema-json"     % "0.4.1"
libraryDependencies += "dev.zio" %% "zio-schema-protobuf" % "0.4.1"

// Required for automatic generic derivation of schemas
libraryDependencies += "dev.zio" %% "zio-schema-derivation" % "0.4.1",
