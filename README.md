...
```scala
libraryDependencies += "dev.zio" %% "zio-schema"          % "1.7.0"
libraryDependencies += "dev.zio" %% "zio-schema-avro"     % "1.7.0"
libraryDependencies += "dev.zio" %% "zio-schema-bson"     % "1.7.0"
libraryDependencies += "dev.zio" %% "zio-schema-json"     % "1.7.0"
libraryDependencies += "dev.zio" %% "zio-schema-msg-pack" % "1.7.0"
libraryDependencies += "dev.zio" %% "zio-schema-protobuf" % "1.7.0"
libraryDependencies += "dev.zio" %% "zio-schema-thrift"   % "1.7.0"
libraryDependencies += "dev.zio" %% "zio-schema-zio-test" % "1.7.0"

// Required for the automatic generic derivation of schemas
libraryDependencies += "dev.zio" %% "zio-schema-derivation" % "1.7.0"
