...
```scala
libraryDependencies += "dev.zio" %% "zio-schema"          % "1.8.2"
libraryDependencies += "dev.zio" %% "zio-schema-avro"     % "1.8.2"
libraryDependencies += "dev.zio" %% "zio-schema-bson"     % "1.8.2"
libraryDependencies += "dev.zio" %% "zio-schema-json"     % "1.8.2"
...
libraryDependencies += "dev.zio" %% "zio-schema-derivation" % "1.8.2"
