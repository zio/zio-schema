...
```scala
libraryDependencies += "dev.zio" %% "zio-schema"          % "0.0.5"
libraryDependencies += "dev.zio" %% "zio-schema-json"     % "0.0.5"
libraryDependencies += "dev.zio" %% "zio-schema-protobuf" % "0.0.5"

// Required for automatic generic derivation of schemas
libraryDependencies += "dev.zio" %% "zio-schema-derivation" % "0.0.5",
