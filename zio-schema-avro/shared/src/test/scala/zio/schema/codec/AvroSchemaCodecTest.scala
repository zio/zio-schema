...
object AvroSchemaCodecTest extends DefaultRunnableSpec {

  override def spec: ZSpec[TestEnvironment, Any] = suite("AvroSchemaCodec")(
    suite("encode")(
      suite("enum")(
      ...
      suite("primitives")(
        ...
        test("encodes Duration") {
          val schema = Schema.primitive(StandardType.Duration(ChronoUnit.DAYS))
          val result = AvroSchemaCodec.encode(schema)
    ...
    suite("decode")(
      suite("record")(
        ...
        test("duration record without chrono unit annotation") {
          ...
          assert(schema)(isRight(isStandardType(StandardType.Duration(ChronoUnit.MILLIS))))
        },
        test("duration record chrono unit annotation") {
          ...
          assert(schema)(isRight(isStandardType(StandardType.Duration(ChronoUnit.DAYS))))
        },
...
object AssertionHelper {
  ...
  def asString(assertion: Assertion[String]): Assertion[Any] =
    Assertion.assertionRec("asString")(param(assertion))(assertion) {
