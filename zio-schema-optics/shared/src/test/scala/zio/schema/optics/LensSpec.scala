...
object LensSpec extends DefaultRunnableSpec {
  ...
  object TestClass {
    implicit lazy val schema: Schema.CaseClass3[Int, String, Long, TestClass] = SchemaDerivation.gen[TestClass]
    ...
    lazy val (field1, field2, field3) = schema.makeAccessors(ZioOpticsBuilder)
