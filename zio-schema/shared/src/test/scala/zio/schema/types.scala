...
object types {
  ...
  object Arities extends DefaultJavaTimeSchemas {
    ...
    object Arity9 {
      implicit lazy val schema: Schema[Arity9] = SchemaDerivation.gen
    }
    ...
    object Arity10 {
      implicit lazy val schema: Schema[Arity10] = SchemaDerivation.gen
    }
    ...
    object Arity11 {
      implicit lazy val schema: Schema[Arity11] = SchemaDerivation.gen
    }
    ...
    object Arity12 {
      implicit lazy val schema: Schema[Arity12] = SchemaDerivation.gen
    }
    ...
    object Arity13 {
      implicit lazy val schema: Schema[Arity13] = SchemaDerivation.gen
    }
    ...
    object Arity14 {
      implicit lazy val schema: Schema[Arity14] = SchemaDerivation.gen
    }
    ...
    object Arity15 {
      implicit lazy val schema: Schema[Arity15] = SchemaDerivation.gen
    }
    ...
    object Arity16 {
      implicit lazy val schema: Schema[Arity16] = SchemaDerivation.gen
    }
    ...
    object Arity17 {
      implicit lazy val schema: Schema[Arity17] = SchemaDerivation.gen
    }
    ...
    object Arity18 {
      implicit lazy val schema: Schema[Arity18] = SchemaDerivation.gen
    }
    ...
    object Arity19 {
      implicit lazy val schema: Schema[Arity19] = SchemaDerivation.gen
    }
    ...
    object Arity20 {
      implicit lazy val schema: Schema[Arity20] = SchemaDerivation.gen
    }
    ...
    object Arity21 {
      implicit lazy val schema: Schema[Arity21] = SchemaDerivation.gen
    }
    ...
    object Arity22 {
      implicit lazy val schema: Schema[Arity22] = SchemaDerivation.gen
    }
    ...
    object Arity23 {
      implicit lazy val schema: Schema[Arity23] = SchemaDerivation.gen
    }
    ...
    object Arity24 {
      implicit lazy val schema: Schema[Arity24] = SchemaDerivation.gen
    }

    implicit lazy val schema: Schema[Arities] = SchemaDerivation.gen
  ...
  object Recursive {
    ...
    object RecursiveOption {
      implicit lazy val schema: Schema[RecursiveOption] = SchemaDerivation.gen
    }
    case class RecursiveList(level: String, r: List[Recursive]) extends Recursive

    object RecursiveList {
      implicit lazy val schema: Schema[RecursiveList] = SchemaDerivation.gen
    }
    case class RecursiveEither(level: Long, r: Either[String, Recursive]) extends Recursive

    object RecursiveEither {
      implicit lazy val schema: Schema[RecursiveEither] = SchemaDerivation.gen
    }

    implicit lazy val schema: Schema[Recursive] = SchemaDerivation.gen
  }
  ...
  object EitherVariants {
    implicit lazy val schema: Schema[EitherVariants] = SchemaDerivation.gen
  }
  ...
  object OptionVariants {
    implicit lazy val schema: Schema[OptionVariants] = SchemaDerivation.gen
  }
  ...
  object SequenceVariants {
    implicit lazy val schema: Schema[SequenceVariants] = SchemaDerivation.gen
  }
